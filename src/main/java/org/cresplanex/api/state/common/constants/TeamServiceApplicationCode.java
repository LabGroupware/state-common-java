...
public class TeamServiceApplicationCode {
    ...
    public static final String WILL_ADDED_USER_DUPLICATED = ServicePrefix.TEAM + "1009";
    public static final String NOT_ALLOWED_USERS_CONTAIN_OWNER = ServicePrefix.TEAM + "1010";
}
